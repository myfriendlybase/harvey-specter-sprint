...
export const metadata: Metadata = {
  title: 'Licences — Harvey Specter',
  description: 'Licensing information for content and software used on this site.',
};
...
const QUERY = `*[_type == "legalPage" && slug.current == "licences"][0]{
  title, lastUpdated,
